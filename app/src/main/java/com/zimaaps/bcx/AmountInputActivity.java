...
import com.standard.app.activity.ScanActivity;
...
public class AmountInputActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_9:
                ...
                break;
            case R.id.btn_back:
                if (mAmountBuilder.length() > 3) {
                    mAmountBuilder.delete(mAmountBuilder.length() - 3, mAmountBuilder.length());
                }
                setText(null);
                break;
            case R.id.btn_clear:
                mAmountBuilder.delete(3, mAmountBuilder.length());
                setText(null);
                break;
            ...
            case R.id.btn_search_card:
                PosApplication.getApp().mConsumeData.setAmount(mAmount.substring(3));
    ...
    private void setText(String charNum) {
        ...
        mAmount.insert(mAmount.length()-1, ".");
