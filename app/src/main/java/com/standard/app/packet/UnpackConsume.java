...
public class UnpackConsume {
    private static final String TAG = Utils.TAGPUBLIC + UnpackConsume.class.getSimpleName();

    private byte[] mField47 = null;
    private String resMsg = null;
    private String resDetail = null;

    public UnpackConsume(byte[] srcData, int srcDataLen) {
        Log.d(TAG, "UnpackConsume ... ");
