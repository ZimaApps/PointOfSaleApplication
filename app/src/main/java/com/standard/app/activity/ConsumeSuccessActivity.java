...
public class ConsumeSuccessActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        byte[] pin = PosApplication.getApp().mConsumeData.getPin();
        byte[] ksnValue = PosApplication.getApp().mConsumeData.getKsnValue();
        byte[] ICCDATA = PosApplication.getApp().mConsumeData.getICData();
        byte[] ICCPOSITIVEDATA = PosApplication.getApp().mConsumeData.getICPositiveData();
        String EXPIREDATA = PosApplication.getApp().mConsumeData.getExpiryData();
        String SECONDTRACK = PosApplication.getApp().mConsumeData.getSecondTrackData();
        String SERIALNUMBER = PosApplication.getApp().mConsumeData.getSerialNum();
        String THIRDTRACK = PosApplication.getApp().mConsumeData.getThirdTrackData();
        String SCANRESULT = PosApplication.getApp().mConsumeData.getScanResult();
        ...
        Log.i(TAG, "SECONDTRACK: " + SECONDTRACK);
        Log.i(TAG, "THIRDTRACK: " + THIRDTRACK);
        ...
        mConsumePrint = new ConsumePrint(this, null);
...
//                        }
                    ...
                    break;
                case ConsumePrint.MSG_TASK_SHOW_RESULT:
                    showDialog(null, msg.getData().getString("message"));
                    break;
                case ConsumePrint.MSG_TASK_PRINT:
                    showPrintDialog();
                    break;
                default:
                    break;
...
//            }
    ...
    protected void onDestroy() {
        ...
        mHandle.removeMessages(ConsumePrint.MSG_TASK_SHOW_RESULT);
        mHandle.removeMessages(ConsumePrint.MSG_TASK_PRINT);
