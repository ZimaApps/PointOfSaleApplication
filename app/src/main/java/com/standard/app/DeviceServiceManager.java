...
import com.lkl.cloudpos.aidl.camera.AidlCameraManager;
import com.lkl.cloudpos.aidl.camera.AidlFacingbackCamera;
...
public class DeviceServiceManager {
    ...
    public AidlCameraManager getCameraManager() {
        try {
            if(mDeviceService != null) {
                Log.i(TAG, "(mDeviceService.getCameraManager() == null) : "+(mDeviceService.getCameraManager() == null));
                Log.i(TAG, "(AidlCameraManager.Stub.asInterface(mDeviceService.getCameraManager())) : "+(AidlCameraManager.Stub.asInterface(mDeviceService.getCameraManager())));
                return AidlCameraManager.Stub.asInterface(mDeviceService.getCameraManager());
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
