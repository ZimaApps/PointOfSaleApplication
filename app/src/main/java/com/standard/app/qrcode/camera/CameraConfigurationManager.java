...
import com.standard.app.qrcode.utils.ScreenUtils;
...
final class CameraConfigurationManager {
    ...
    private static Point getCameraResolution(Camera.Parameters parameters, Point screenResolution) {
        ...
        if (previewSizeValueString != null) {
            SDKLog.d(TAG, "preview-size-values parameter: " + previewSizeValueString);
    ...
    private static Point findBestPreviewSizeValue(CharSequence previewSizeValueString, Point screenResolution) {
        ...
        for (String previewSize : COMMA_PATTERN.split(previewSizeValueString)) {
            ...
            if (dimPosition < 0) {
                SDKLog.d(TAG, "Bad preview-size: " + previewSize);
                continue;
            }
        ...
        if (bestX > 0 && bestY > 0) {
        	Log.i(TAG,"bestX:" + bestX + ",bestY:" + bestY);
	...
	private void setZoom(Camera.Parameters parameters) {
        ...
        if (maxZoomString != null) {
            try {
                ...
                SDKLog.d(TAG, "Bad max-zoom: " + maxZoomString);
            }
        }
        ...
        if (takingPictureZoomMaxString != null) {
            try {
                ...
                SDKLog.d(TAG, "Bad taking-picture-zoom-max: " + takingPictureZoomMaxString);
            }
        }
        ...
        if (parameters.isZoomSupported()) {
            SDKLog.d(TAG, "max-zoom:" + parameters.getMaxZoom());
            parameters.setZoom(parameters.getMaxZoom() / 10);
        } else {
            SDKLog.d(TAG, "Unsupported zoom.");
        }
