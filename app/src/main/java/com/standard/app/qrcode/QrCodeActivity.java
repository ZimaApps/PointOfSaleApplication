package com.standard.app.qrcode;
...
import com.standard.app.qrcode.camera.CameraManager;
import com.standard.app.qrcode.decode.CaptureActivityHandler;
import com.standard.app.qrcode.decode.DecodeImageCallback;
import com.standard.app.qrcode.decode.DecodeImageThread;
import com.standard.app.qrcode.decode.DecodeManager;
import com.standard.app.qrcode.decode.InactivityTimer;
import com.standard.app.qrcode.view.QrCodeFinderView;
...
//    private TextView mTvFlashLightText;
    ...
    private static AidlCameraScanCodeListener mAidlCameraScanCodeListener;
    ...
    private Intent amountIntent = null;
    private String amounts = "0.0";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        amountIntent = getIntent();

        amounts = amountIntent.getStringExtra("amount");
        initView();
        initData();
    }
...
//        mIvFlashLight.setOnClickListener(this);
       // TextView amountTextView = (TextView) findViewById(R.id.pay_amount_tv);
        /*if (amounts != null) {
            amountTextView.setText("Amount of money:" + String.valueOf(amounts));
        }*/
    ...
    protected void onResume() {
        super.onResume();
        Log.i("QrCodeActivity", "onResume: " + mPermissionOk);
        checkPermission();
        if (!mPermissionOk) {
    ...
    public void handleDecode(String result) {
        ...
        if (null == result) {
            ...
            if (mAidlCameraScanCodeListener != null) {
                try {
                    mAidlCameraScanCodeListener.onResult(result);
                    if (mCaptureActivityHandler != null) {
                        mCaptureActivityHandler.quitSynchronously();
                        mCaptureActivityHandler = null;
                    }
...
//    public static interface QrcodeResultListener {
//        void onFail(int errorCode);
//
//        void onSuccess(String code);
//    }

    public static void setAidlCameraScanCodeListener(AidlCameraScanCodeListener listener) {
        mAidlCameraScanCodeListener = listener;
    }
}
