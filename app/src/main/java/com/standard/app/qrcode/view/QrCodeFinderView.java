...
package com.standard.app.qrcode.view;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    private void drawText(Canvas canvas, Rect rect) {
        ...
        if (locale.equals("en")) {
            ...
            left = (ScreenUtils.getScreenWidth(mContext) - mPaint.getTextSize() * text.length()) / 2;
        }
	...
	canvas.drawRect(rect.left + 2, slideTop - 2, rect.right - 1, slideTop + 2, mPaint);
    }
}
