...
import com.standard.app.card.CardMoniterService;
...
public class CardManager {
    private static String TAG = "THE CARDMANAGER";
    ...
    public void setConfirmCardInfo(boolean confirm) {
        if (null == resultCallBack) {
            Log.i(TAG, "setConfirmCardInfo callBack is null");
            return;
        }
    ...
    public void setRequestOnline(boolean online, String respCode, String icc55) {
        if (null == resultCallBack) {
            Log.i(TAG, "setRequestOnline callBack is null");
            return;
        }
    ...
    public void callBackError(int errorCode) {
        if (null == exceptionCallBack) {
            Log.i(TAG, "callBackError callBack is null");
            return;
        }
    ...
    public void callBackCanceled() {
        if (null == exceptionCallBack) {
            Log.i(TAG, "callBackCanceled callBack is null");
            return;
        }
    ...
    public void callBackTransResult (int result) {
        if (null == exceptionCallBack) {
            Log.i(TAG, "callBackTransResult callBack is null");
            return;
        }
    ...
    public void finishPreActivity () {
        if (null == exceptionCallBack) {
            Log.i(TAG, "finishPreActivity callBack is null");
            return;
        }
    ...
    public void startCardDealService(Context mContext) {
        Log.i(TAG, "startCardDealService");
